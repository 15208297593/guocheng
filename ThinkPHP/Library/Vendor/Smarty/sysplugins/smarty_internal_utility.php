    ...
    public static function testInstall(Smarty $smarty, &$errors=null)
    {
        ...
        if (is_dir($source)) {
            $expected = array(
                ...
                "smarty_internal_compilefunction.php" => true,
                ...
                "smarty_internal_compile_private_object_blockfunction.php" => true,
                "smarty_internal_compile_private_objectfunction.php" => true,
                "smarty_internal_compile_private_print_expression.php" => true,
                "smarty_internal_compile_private_registered_block.php" => true,
                "smarty_internal_compile_private_registeredfunction.php" => true,

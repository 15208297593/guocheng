...
return array(
	...
	'pk' => 'case_id',    // 表中主键字段名称
	/********************* 要生成的模型文件中的代码 ******************************/
	'insertFields' => "array('title','createtime','content','hovertitle','hoverone','hovertwo','status','remark','pic')",
	'updateFields' => "array('case_id','title','createtime','content','hovertitle','hoverone','hovertwo','status','remark','pic')",
	'validate' => "
